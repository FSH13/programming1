...
//  opcragen gewenste informatie: oppervlakte rechthoek 1 of 2; verschil
//  oppervlakte rechthoeken; som oppervlakte beide rechthoeken invoer opties:
...
int main(void) {
  ...
  char berekening = get_char("Wil je de oppervlakte van rechthoek (1) of (2), "
                             "of de (S)om of het (V)erschil weten? ");
  //	if (berekening != 1 || berekening != 2 || berekening != 'S' ||
  //berekening != 'V')
  //	{
