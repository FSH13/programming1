...
int main(int argc, string argv[]) {
  ...
  // bereken hoeveel schrikkeljaren er tussen 1800 en year zitten. tel voor elk
  // jaar er 1 bij de dagen tenzij huidige maand <2
  //  komt voor als het jaartal restloos deelbaar is door 4, maar niet door 100
  //  – tenzij het jaartal restloos deelbaar door 400
